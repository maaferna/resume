...
\programming{{$\textbullet$ AWS $\textbullet$ Javascript $\textbullet$ Ruby On Rails/ 3.0}, {$\textbullet$ HTML $\textbullet$ CSS  $\textbullet$ SQL
		$\textbullet$ React $\textbullet$ NodeJS / 4.0}, {$\textbullet$ Linux $\textbullet$ Git  $\textbullet$ SQL $\textbullet$ Microsoft Excel / 5.0}, 
{$\textbullet$ Python $\textbullet$ Django / 6.0}}
\vspace{10mm}
